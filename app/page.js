...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav>
            <ul className="flex space-x-6">
              ...
              <li><a href="#" className="hover:text-blue-400 transition-colors">Tech</a></li>
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {articles.map((article, index) => (
            <div key={index} className="bg-gray-800 rounded-lg overflow-hidden shadow-lg transform hover:scale-105 transition-all duration-300">
      ...
      <footer className="bg-gradient-to-r from-gray-900 to-gray-800 py-8 mt-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col items-center md:items-end">
              <p className="text-gray-400 mb-2">For web, iOS, Android, desktop apps, cybersecurity, and more:</p>
              <a href="mailto:paraboyyy1704@gmail.com" className="text-blue-400 hover:text-blue-300 transition-colors">
                paraboyyy1704@gmail.com
              </a>
            </div>
          </div>
          <div className="mt-8 pt-8 border-t border-gray-700 flex justify-center space-x-6">
            ...
            <a href="https://github.com/marmikmewada" className="text-gray-400 hover:text-white transition-colors">
